...
import com.example.eduh_mik.schoolconnect2.fragments.ActivitiesFragment;
import com.example.eduh_mik.schoolconnect2.fragments.ContactFragment;
import com.example.eduh_mik.schoolconnect2.fragments.GalleryFragment;
import com.example.eduh_mik.schoolconnect2.fragments.NoticesFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_account) {
           ...
           startNewActivity(AboutUs.class);
            ...
            startNewActivity(ReportsActivity.class);
        }
